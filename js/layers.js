addLayer("J", {
    name: "jackpots", // This is optional, only used in a few places, If absent it just uses the layer id.
    ...
    resource: "jackpot points", // Name of prestige currency
    ...
    hotkeys: [
        {key: "j", description: "J: Reset for jackpot points", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
