...
function getPointGen() {
	...
	if (hasUpgrade('p', 33)) gain = gain.times(10)
	if (hasUpgrade('p', 34)) gain = gain.times(10)
	if (hasUpgrade('p', 35)) gain = gain.times(10)
	return gain
}
